...
export default function Auth() {
  ...
  const handleOAuthLogin = async (provider: 'google' | 'github') => {
    ...
    try {
      ...
      // Note: Loading state will be cleared by redirect
    } catch (error) {
      toast({
        variant: "destructive",
        title: "Erro inesperado",
        description: "Não foi possível fazer login com OAuth.",
      });
      setLoading(false);
    }
  };
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-background px-2 text-text-tertiary">Ou continue com</span>
                  </div>
                </div>
